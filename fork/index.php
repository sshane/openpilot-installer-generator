...
# Handle aliases
$aliases = [new Alias("dragonpilot-community", "devel-i18n", ["dragonpilot", "dp"], "", "dragonpilot"), new Alias("commaai", DEFAULT_STOCK_BRANCH, ["stock", "commaai"], "", "openpilot"),
            new Alias("shanesmiskol", "stock_additions", ["shane", "smiskol", "sa", "shanesmiskol"], "", "Stock Additions"), new Alias("tundergit", "200-devel", ["tundergit", "waifupilot"], "waifupilot", "waifupilot")];
